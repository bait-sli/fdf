...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/03/16 03:18:03 by bait-sli          #+#    #+#             */
/*   Updated: 2017/03/16 03:18:06 by bait-sli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	mlx_string_put(mlx, win, 10, 5, 0xFFA509, "Autor: bait-sli");
	mlx_string_put(mlx, win, 10, 20, 0xFFA509, "Zoom: [+][-]");
	mlx_string_put(mlx, win, 10, 35, 0xFFA509, "Rotation: [X][Y]");
	mlx_string_put(mlx, win, 10, 50, 0xFFA509, "Move: [UP][DOWN][RIGHT][LEFT]");
	mlx_string_put(mlx, win, 10, 65, 0xFFA509, "Height ratio: [1][2]");
	mlx_string_put(mlx, win, 10, 82, 0xFFA509, "Reset view: [R]");
	mlx_string_put(mlx, win, 10, 99, 0xFFA509, "Exit: [ESC]");
}
